...
export default {
  ...
  methods:{
    ...
    async editVF(){/*permette modifica degli elementi del db*/
      await this.getViaggiFatti();
      await fetch(`http://127.0.0.1:8000/api/viaggi-fatti/${this.ViaggiFatti.id}/`, {
        method:'put',
        headers:{
    ...
    async editVdF(){/*permette modifica degli elementi del db*/
      await this.getViaggiDaFare();
      await fetch(`http://127.0.0.1:8000/api/viaggi-da-fare/${this.ViaggiDaFare.id}/`, {
        method:'put',
        headers:{
          'Content-Type': 'application/json'
        },
    ...
    async eliminaVF(element){/*permette di eliminare elementi dal db*/
      await this.getViaggiFatti();
      await fetch(`http://127.0.0.1:8000/api/viaggi-fatti/${element.id}/`, {
        method:'delete',
        headers:{
          'Content-Type': 'application/json'
        },
